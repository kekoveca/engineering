...
data40mm = np.loadtxt("Lab1data/40mm.txt", dtype= int)
data120mm = np.loadtxt("Lab1data/120mm.txt", dtype= int)
data160mm = np.loadtxt("Lab1data/160mm.txt", dtype= int)
data180mm = np.loadtxt("Lab1data/180mm.txt", dtype= int)
...
plt.minorticks_on()
fig1.savefig("calpress.png")

## FITNESS 

dataRawFitness = np.loadtxt("Lab1data/chel1sport.txt", dtype= int)
...
fig2.savefig("fintess-press.png")
...
figp2.savefig("fitness-p.png") 

## CALM

dataRawCalm = np.loadtxt("Lab1data/chel2.txt", dtype= int)
